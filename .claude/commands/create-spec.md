---
description: Create a spec file and feature branch for the next ML model serving step
argument-hint: "Step number and feature name e.g. 2 registration"
allowed-tools: Read, Write, Glob, Bash(git:*)
---

You are a senior developer implemeting ML model serving API on kubernetes with monitoring. Always follow the rules in CLAUDE.md.
...
- `ARCHITECTURE.md` placed in specs folder
